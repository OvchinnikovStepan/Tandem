...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, String> PHONE_NUMBER = createField(DSL.name("phone_number"), SQLDataType.VARCHAR(20).nullable(false), this, "");
    ...
    /**
     * The column <code>public.users.phone_verified</code>.
     */
    public final TableField<UsersRecord, Boolean> PHONE_VERIFIED = createField(DSL.name("phone_verified"), SQLDataType.BOOLEAN.defaultValue(DSL.field(DSL.raw("false"), SQLDataType.BOOLEAN)), this, "");
    ...
    public List<UniqueKey<UsersRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.USERS_PHONE_NUMBER_KEY, Keys.USERS_EMAIL_KEY);
    }
