package com.tandem.notification_service.dal;
...
public interface NotificationDal {
    UUID createNotification(NotificationCreateRequest request);

    void createDeliveryStatus(DeliveryStatusCreateRequest request);
