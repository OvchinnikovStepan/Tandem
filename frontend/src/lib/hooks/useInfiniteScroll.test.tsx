...
describe("useInfiniteScroll", () => {
  ...
  it("does not call onLoadMore when loading", () => {
    ...
    render(
      <TestComponent hasMore isLoading onLoadMore={onLoadMore} />
    );
  ...
  it("does not observe when hasMore is false", () => {
    ...
    render(
      <TestComponent hasMore={false} isLoading={false} onLoadMore={onLoadMore} />
    );
  ...
  it("does not observe when disabled", () => {
    ...
    render(
      <TestComponent hasMore isLoading={false} enabled={false} onLoadMore={onLoadMore} />
    );
