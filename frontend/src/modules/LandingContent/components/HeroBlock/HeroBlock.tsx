                ...
                <div className="flex flex-col items-center gap-10 lg:gap-0 md:flex-row md:justify-between">
                    <div className="space-y-8">
                        <div className="space-y-4">
                            <h1 className="text-2xl leading-tight sm:text-3xl md:text-heading md:leading-12 font-roboto font-bold text-heading-black">
                                {t("landing.hero.title")}
                            </h1>
                            <p className="text-sm font-roboto font-normal sm:text-md md:leading-6 text-base-black">
